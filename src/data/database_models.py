...
class PlayerAdvancedStats(Base):
    ...
    first_name = Column(String(50))
    last_name = Column(String(50))
    starting_position = Column(String(5), nullable=True)
    starter = Column(Boolean, default=False)
    status = Column(String(20), nullable=True)
    status_reason = Column(String(50), nullable=True)
    minutes = Column(String(8), nullable=True)
    ...
    pace_per40 = Column(Float, nullable=True)
    possessions = Column(Integer, nullable=True)
...
class TeamAdvancedStats(Base):
    ...
    defensive_rebound_percentage = Column(Float, nullable=True)
    rebound_percentage = Column(Float, nullable=True)
    estimated_team_turnover_percentage = Column(Float, nullable=True)
    turnover_ratio = Column(Float, nullable=True)
    effective_field_goal_percentage = Column(Float, nullable=True)
    true_shooting_percentage = Column(Float, nullable=True)
    estimated_pace = Column(Float, nullable=True)
